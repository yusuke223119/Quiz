...
const allQuestions = [
  {
    ...
    question: `
      ...
      この5人の得点データの「標本分散」と「標準偏差」の組合せとして最も適切なものを、次の ①〜④ のうちから1つ選べ。ただし、解は近似値ではなく厳密な値で表記されている。<br><br>
  ...
  },
  {
    ...
    question: `
      ...
      \\[
        y_i=-2x_i+30
      \\]
      この新しいデータ \\(Y\\) の「平均値 \\(\\bar{y}\\)」、「標本分散 \\(s_y^2\\)」、「標準偏差 \\(s_y\\)」の組合せとして最も適切なものを、次の ①〜④ のうちから1つ選べ。<br><br>
      <table class='w-full border-collapse border border-slate-300 text-center text-sm'>
        <thead>
          <tr class='bg-slate-100'>
            <th class='border border-slate-300 p-1'></th>
  ...
  },
  {
    ...
    question: `
      ...
      とするとき、偏差値は
      \\[T=50+10z\\]
      で定義される。両教科の得点分布は正規分布に従い、\\(Z=1.0\\)（偏差値60）以上の割合は約16%、\\(Z=2.0\\)（偏差値70）以上の割合は約2.3%であるとする。<br><br>
