const allQuestions = [
  {
    ...
    type: "選択式",
    question: `
      仮説検定に関する次のア〜ウの言葉が表す語句の組合せとして正しいものを、下の表の1〜4から選べ。<br>
      <br>
  ...
  },
  {
    ...
    question: `
      ...
      \\]
      を有意水準 5% で検定するとき、検定統計量 \\(t\\) の値と結論の組合せとして正しいものはどれか。ただし、自由度 8 の \\(t\\) 分布の上側 2.5% 点は 2.306 である。<br>
      ① \\(t = 2.0\\)、帰無仮説は棄却される<br>
  ...
  },
  {
    ...
    question: `
      ...
      「両群の母平均は等しい」という帰無仮説を有意水準 5% で両側検定するとき、検定統計量 \\(t\\) の値・自由度・結論の組合せとして正しいものはどれか。ただし、自由度 14 の \\(t\\) 分布の上側 2.5% 点は 2.145 である。<br>
  ...
  },
  {
    ...
    question: `
      ...
      「両地域の母比率は等しい（\\(H_0: p_A = p_B\\)）」を有意水準 5% で両側検定する。プールした標本比率 \\(\\hat{p} = \\frac{40+55}{200} = 0.475\\) を用いるとき、検定統計量 \\(Z\\) のおよその値と結論の組合せとして正しいものはどれか。<br>
  ...
  },
  {
    ...
    question: `
      ...
      「どの目も等しい確率 \\(1/6\\) で出る」という帰無仮説の適合度検定を行うとき、カイ二乗統計量 \\(\\chi^2\\) の値と自由度の組合せとして正しいものはどれか。<br>
      ① \\(\\chi^2 = 5.0\\)、自由度 5<br>
      ② \\(\\chi^2 = 5.0\\)、自由度 6<br>
      ③ \\(\\chi^2 = 2.5\\)、自由度 5<br>
      ④ \\(\\chi^2 = 50\\)、自由度 5
  ...
  },
  {
    ...
    question: `
      ...
      このクロス表に対して独立性のカイ二乗検定を行うとき、「喫煙あり かつ 疾患あり」のセルの期待度数と、検定の自由度の組合せとして正しいものはどれか。<br>
      ① 期待度数 20、自由度 1<br>
      ② 期待度数 20、自由度 4<br>
      ③ 期待度数 25、自由度 1<br>
      ④ 期待度数 10、自由度 2
